...
import { lookupInCache } from '../resources/scripts/MYSQL_cache/cache-lookup.js';
...
export const data = new SlashCommandBuilder()
    ...
    .addStringOption(option => option.setName('keyword')
        ...
        .setRequired(true))
    .addStringOption(option => option.setName('actiontype')
    ...
    .addStringOption(option => option.setName('actioncontent')
